...
class NbreAnnoncesES {
	...
	def nombreLien(){
		...
		WebUI.delay(5)
		String nbrannonces = WebUI.getText(findTestObject('Object Repository/coherence/Page_iad - Vente achat location maison appartement immobilier de proximit/p_5 rsultats sur 445 biens  louer en France'))
		...
		while (WebUI.verifyElementPresent(findTestObject('Object Repository/page accuiel/Page_iad - Vente achat location maison appartement immobilier de proximit/a_Contactez votre conseiller_next') , 5, FailureHandling.OPTIONAL)) {
