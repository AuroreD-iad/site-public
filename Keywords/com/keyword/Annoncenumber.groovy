...
class Annoncenumber {
	...
	def nombreLien(){
		...
		WebUI.delay(5)
		String nbrannonces = WebUI.getText(findTestObject('Nombre annonce/Page_iad - Vente achat location maison appa_3091d3/p_267 rsultats sur 52937 biens  vendre en France'))
		...
		while (WebUI.verifyElementPresent(findTestObject('Nombre annonce/Page_iad - Vente achat location maison appa_3091d3/a__next'), 5, FailureHandling.OPTIONAL)) {
