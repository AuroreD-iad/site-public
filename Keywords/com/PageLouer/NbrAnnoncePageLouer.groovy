...
class NbrAnnoncePageLouer {
	...
	def nombreLien(){
		...
		WebUI.delay(5)
		String nbrannonces = WebUI.getText(findTestObject('Page_iad - Alquilar su propiedad en Espana con nuestro asesor de iad/p_41 resultados'))
		...
		while (WebUI.verifyElementPresent(findTestObject('nbrAn/Page_iad - Alquilar su propiedad en Espana con nuestro asesor de iad/a__next') , 5, FailureHandling.OPTIONAL)) {

			//driver.findElement(By.xpath("//ul//li//a[@class=' next']")).click()
			WebUI.click(findTestObject('nbrAn/Page_iad - Alquilar su propiedad en Espana con nuestro asesor de iad/a__next'))
