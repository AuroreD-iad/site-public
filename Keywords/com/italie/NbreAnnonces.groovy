...
class NbreAnnoncees {
	...
	def nombreLien(){
		...
		WebUI.delay(5)
		String nbrannonces = WebUI.getText(findTestObject('IT-nbreAnnonce/p_44 risultati'))
		...
		while (WebUI.verifyElementPresent(findTestObject('IT-nbreAnnonce/a__next') , 5, FailureHandling.OPTIONAL)) {
			//driver.findElement(By.xpath("//ul//li//a[@class=' next']")).click()
			WebUI.click(findTestObject('Annonces/a__next'))
