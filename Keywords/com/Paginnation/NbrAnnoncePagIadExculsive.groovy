...
class NbrAnnoncePagIadExculsive {
	...
	def nombreLien(){
		...
		WebUI.delay(5)
		String nbrannonces = WebUI.getText(findTestObject('Page_iad - Comprar su propiedad en Espana con nuestro asesor de iad/p_200 resultados'))
		...
		while (WebUI.verifyElementPresent(findTestObject('Page_iad - Comprar su propiedad en Espana con nuestro asesor de iad/a__nextExclusive') , 5, FailureHandling.OPTIONAL)) {
