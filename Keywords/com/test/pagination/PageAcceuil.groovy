...
public class PageAcceuil {
	...
	def nombreLien(){
		...
		WebUI.delay(5)
		String nbrannonces = WebUI.getText(findTestObject('Page_iad - propiedades en venta - favorito - Espana/p_479 resultados'))
		...
		while (WebUI.verifyElementPresent(findTestObject('Page_iad - propiedades en venta - favorito - Espana/a__next') , 5, FailureHandling.OPTIONAL)) {

			//driver.findElement(By.xpath("//ul//li//a[@class=' next']")).click()
			WebUI.click(findTestObject('Page_iad - propiedades en venta - favorito - Espana/a__next'))
