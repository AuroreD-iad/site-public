...
class NombreAnnonce {
	...
	def nombreLien(){
		...
		WebUI.delay(5)
		String nbrannonces = WebUI.getText(findTestObject('Object Repository/page accuiel/Page_iad - Vente achat location maison appartement immobilier de proximit/p_93 rsultats'))
