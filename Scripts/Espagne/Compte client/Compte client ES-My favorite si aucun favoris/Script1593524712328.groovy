...
WebUI.verifyElementPresent(findTestObject('sans favoris/Page_iad - Comprar vender y alquilar una casa o un piso en Espaa/a_Sigue esta propiedad'), 
    0)

WebUI.verifyElementPresent(findTestObject('sans favoris/Page_iad - Comprar vender y alquilar una casa o un piso en Espaa/b_No tienes favoritos'), 
    0)

WebUI.verifyElementPresent(findTestObject('sans favoris/Page_iad - Comprar vender y alquilar una casa o un piso en Espaa/h1_Mis anuncios favoritos'), 
    0)

WebUI.verifyElementPresent(findTestObject('sans favoris/Page_iad - Comprar vender y alquilar una casa o un piso en Espaa/img'), 
    0)
