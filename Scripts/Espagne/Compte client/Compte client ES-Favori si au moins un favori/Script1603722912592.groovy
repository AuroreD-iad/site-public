...
not_run: WebUI.verifyElementPresent(findTestObject('sans favoris/Page_iad - Comprar vender y alquilar una casa o un piso en Espaa/a_Comenzar mi bsqueda'), 
    0)

not_run: WebUI.click(findTestObject('sans favoris/Page_iad - Comprar vender y alquilar una casa o un piso en Espaa/a_Comenzar mi bsqueda'), 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.setText(findTestObject('ES-Favoris/input_Alquilar_whereToBuy'), 'madrid')

not_run: WebUI.click(findTestObject('ES-Favoris/li_Comunidad de Madrid'))

not_run: WebUI.click(findTestObject('ES-Favoris/button_Buscar'))

not_run: WebUI.click(findTestObject('ES-Favoris/i_Valdemoro (28341)_demo-icon icon-star-1 pointer'))
