...
WebUI.click(findTestObject('IT-prestige-msg de confirmation/button_Next'))
...
WebUI.verifyElementPresent(findTestObject('IT-prestige-msg de confirmation/a_Segui questo immobile'), 0)
...
WebUI.verifyElementPresent(findTestObject('IT-prestige-msg de confirmation/div_                                Captcha verification failed'), 
    0)
