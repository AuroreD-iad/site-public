...
not_run: WebUI.click(findTestObject('alertes-italia/span_CHIUDERE'))
...
WebUI.setText(findTestObject('ITA - Site public Italie/04 - Connexion compte/ITA_input_user_email'), 'had.a@gmail.it')

WebUI.setEncryptedText(findTestObject('ITA - Site public Italie/04 - Connexion compte/ITA_input__password'), 'U7ULkjol2U8D0Pq064e+Nw==')
