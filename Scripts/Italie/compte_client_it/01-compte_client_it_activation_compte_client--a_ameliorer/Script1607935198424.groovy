...
// fin import
WebUI.callTestCase(findTestCase('Italie/compte_client/01-creation_compte_client--ok'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('01 - MailDev/Alerte votre connexion n est pas privee/Bouton parametres avances'))

WebUI.click(findTestObject('01 - MailDev/Alerte votre connexion n est pas privee/Lien continuer vers le site'))

WebUI.click(findTestObject('01 - MailDev/mail titre - Crea il tuo account'))

WebUI.delay(3)

WebUI.click(findTestObject('01 - MailDev/a_Conferma la mia iscrizione'))
