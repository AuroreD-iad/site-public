...
WebUI.click(findTestObject('formulaire etre recontacté/Page_iad - Vente achat location maison appartement immobilier de proximit/span_FERMER'))

WebUI.click(findTestObject('Page_iad - Vente achat location maison appa_3091d3/a_Nous rejoindre'))
